...
class FirestoreSyncManager(private val db: FirebaseFirestore = FirebaseFirestore.getInstance()) {
    
    private val vehiclesCollection = db.collection("vehicles")
    private val usersCollection = db.collection("users")
    private val historiesCollection = db.collection("search_histories")
    ...
    suspend fun getVehicles(): List<Vehicle> {
        val result = vehiclesCollection.get().await()
    ...
    private val filesCollection = db.collection("uploaded_files")
