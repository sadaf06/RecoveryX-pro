...
val md_theme_light_primaryContainer = Color(0xFFE8F0FF)
...
val md_theme_light_onSurfaceVariant = Color(0xFF535F70)

val md_theme_light_outline = Color(0xFF73777F)
val md_theme_light_outlineVariant = Color(0x3373777F)
